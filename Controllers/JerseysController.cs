...
namespace GearShopV2.Controllers
{
    public class JerseysController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,JBrand,JModel,JColor,JSize,JPrice,JSalePrice,JQtyOnHand")] Jersey jersey)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JBrand,JModel,JColor,JSize,JPrice,JSalePrice,JQtyOnHand")] Jersey jersey)
        {
            if (id != jersey.Id)
            {
                return NotFound();
